...
RUN DEBIAN_FRONTEND=noninteractive apt-get -y install apache2 libapache2-mod-php7.2 sudo rsyslog wget mysql-client curl nodejs
RUN DEBIAN_FRONTEND=noninteractive apt-get -y install php7.2-cli php7.2-xml php7.2-mysql php7.2-pgsql php7.2-json php7.2-curl php7.2-mbstring php7.2-intl php7.2-redis php7.2-dev php-pear composer
...
# Add zip toolbox
RUN DEBIAN_FRONTEND=noninteractive apt-get -y install zip unzip php-zip
...
# Setup awscli
RUN DEBIAN_FRONTEND=noninteractive apt-get -y install python3 python3-pip rsync git wget rinetd
